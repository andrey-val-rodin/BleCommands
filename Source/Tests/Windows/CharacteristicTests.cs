...
namespace BleCommands.Tests.Windows
{
    public class CharacteristicTests
    {
        ...
        public async Task WriteAsync_CannotWrite_ThrowsInvalidOperationException()
        {
            ...
            Assert.Equal("The characteristic is neither Write nor Write without response.", exception.Message);
        }
        ...
        public void AttachTokenAggregator_CannotUpdate_ThrowsInvalidOperationException()
        {
            ...
            Assert.Equal("The characteristic is neither Update nor Indicate.", exception.Message);
        }
